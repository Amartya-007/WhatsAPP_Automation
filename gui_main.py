...
ctk.set_appearance_mode("Light")  # Light mode for white background
...
LIGHT_BLUE_BG = "#f0f8ff"  # Alice blue background for sections
BLUE_TEXT = "#0066cc"      # Blue text for headers
...
class WhatsAppGUI:
    def __init__(self):
        ...
        self.root.geometry("700x700")  # Optimized window size
        self.root.minsize(650, 600)  # Minimum size for usability
        self.root.resizable(True, True)
        self.root.configure(fg_color=WHITE_BG)  # Set white background
    ...
    def setup_ui(self):
        """Setup the user interface without external dependencies"""        # Main title
        ...
        # Setup all sections in scrollable frame
        self.setup_recipient_section(self.scrollable_frame)
        self.setup_message_section(self.scrollable_frame)
        self.setup_scheduling_section(self.scrollable_frame)
        self.setup_action_buttons(self.scrollable_frame)
        self.setup_status_section(self.scrollable_frame)
        
    def setup_recipient_section(self, parent):
        """Setup recipient information section"""
        recipient_frame = ctk.CTkFrame(parent, fg_color=LIGHT_BLUE_BG)
    ...
    def setup_message_section(self, parent):
        ...
        message_frame = ctk.CTkFrame(parent, fg_color=LIGHT_BLUE_BG)
    ...
    def setup_scheduling_section(self, parent):
        ...
        scheduling_frame = ctk.CTkFrame(parent, fg_color=LIGHT_BLUE_BG)
